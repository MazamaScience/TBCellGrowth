...
if (FALSE) {
  ...
  opt <- parseCommandLineArguments(args)
...
parseCommandLineArguments <- function(args=commandArgs(trailingOnly=TRUE)) {
...
validateRunOptions <- function(opt) {
